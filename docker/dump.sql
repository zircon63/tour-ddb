CREATE DATABASE  IF NOT EXISTS `pizza-store` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `pizza-store`;
-- MySQL dump 10.13  Distrib 5.7.28, for Linux (x86_64)
--
-- Host: localhost    Database: pizza-store
-- ------------------------------------------------------
...
CREATE TABLE `order_product` (
  ...
  CONSTRAINT `fk_order_product_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`),
  CONSTRAINT `fk_order_product_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `password` varchar(21000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-24 18:59:35
